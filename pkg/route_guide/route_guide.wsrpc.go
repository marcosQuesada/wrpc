...
import (
	"context"
	rpc "github.com/marcosQuesada/xrpc"
	"github.com/marcosQuesada/xrpc/stream"
...
func NewRouteGuideClient(cc stream.Handler) RouteGuideClient {
...
func RegisterRouteGuideServer(s *rpc.Server, srv RouteGuideServer) {
